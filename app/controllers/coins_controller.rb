class CoinsController < ApplicationController
  ...
  before_action :set_minning_types_options, only: [:new, :create, :edit, :update]
  ...
  private
    ...
    def set_minning_types_options
      @minning_types_options = MinningType.all.pluck(:description, :id)
    end
    ...
    def coin_params
      params.require(:coin).permit(:description, :acronym, :url_image, :minning_type)
    end
end
